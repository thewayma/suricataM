...
func (this *GraphItem) String() string {
	return fmt.Sprintf(
		...
		this.Value,
		this.Timestamp,
		utils.UnixTsFormat(this.Timestamp),
		this.DsType,
		this.Step,
		this.Heartbeat,
		this.Min,
...
func (this *GraphItem) PrimaryKey() string {
	return utils.PK(this.Endpoint, this.Metric, this.Tags)
}

func (t *GraphItem) Checksum() string {
	return utils.Checksum(t.Endpoint, t.Metric, t.Tags)
}

func (this *GraphItem) UUID() string {
	return utils.UUID(this.Endpoint, this.Metric, this.Tags, this.DsType, this.Step)
}
